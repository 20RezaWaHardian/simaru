...
<div class="main-content">
      ...
      <div class="container">
        <div class="header-body">
          <div class="row align-items-center">
            <div class="col-lg-6">
              <div class="pr-5">
                <h1 class="display-2 text-white font-weight-bold mb-0">Sistem Informasi</h1>
                <h2 class="display-4 text-white font-weight-light">Manajemen Ruangan Universitas Jambi</h2>
                <p class="text-white mt-4">merupakan sistem informasi yang memberikan informasi ruangan baik yang dapat digunakan maupun sedang digunakan, untuk dapat meminjam ruangan silahkan login ke dalam sistem.</p>
                <div class="mt-5">
                  <a href="{{route('login')}}" class="btn btn-neutral my-2">Login</a>
                  <a href="#" class="btn btn-default my-2">Cek Ruangan</a>
                </div>
              </div>
            </div>
            <div class="col-lg-6">
                ...
                <div class="col-md-6">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <h5 class="h3">Ruang Kuliah</h5>
                      <p>Saat ini setiap prodi dapat menggunakan ruangan mana saja yang tersedia.</p>
                    </div>
                  </div>
                  <div class="card">
                    <div class="card-body">
                      ...
                      <h5 class="h3">Ruang Rapat</h5>
                      <p>Lebih mudah memilih ruangan untuk rapat.</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 pt-lg-5 pt-4">
                  <div class="card mb-4">
                    <div class="card-body">
                      ...
                      <h5 class="h3">Ruang Seminar/Workshop</h5>
                      <p>Pilih ruangan terbaik untuk seminar/workshop.</p>
                    </div>
                  </div>
                  <div class="card mb-4">
                    <div class="card-body">
                      ...
                      <h5 class="h3">Balairung</h5>
                      <p>Balairung dapat digunakan siapa saja.</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="container">
        <div class="row row-grid align-items-center">
          <div class="col-md-6 order-md-2">
            <img src="{{asset('assets_dashboard/img/theme/landing-1.png')}}" class="img-fluid">
          </div>
    ...
    <section class="py-6">
      <div class="container">
        <div class="row row-grid align-items-center">
          <div class="col-md-6">
            <img src="{{asset('assets_dashboard/img/theme/landing-2.png')}}" class="img-fluid">
          </div>
          <div class="col-md-6">
            <div class="pr-md-5">
              <h1>Example pages</h1>
    ...
    <section class="py-6">
      <div class="container">
        <div class="row row-grid align-items-center">
          <div class="col-md-6 order-md-2">
            <img src="{{asset('assets_dashboard/img/theme/landing-3.png')}}" class="img-fluid">
          </div>
          <div class="col-md-6 order-md-1">
            <div class="pr-md-5">
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-md-2 col-3 my-2">
                  <a href="https://vuejs.org/" target="_blank" data-toggle="tooltip" data-original-title="[Coming Soon] Vue.js - The progressive javascript framework">
                    <img src="https://s3.amazonaws.com/creativetim_bucket/tim_static_images/presentation-page/vue.jpg" class="img-fluid rounded-circle opacity-3">
                  </a>
                </div>
                <div class="col-md-2 col-3 my-2">
                ...
                <div class="col-md-2 col-3 my-2">
                  <a href="https://angularjs.org/" target="_blank" data-toggle="tooltip" data-original-title="[Coming Soon] React - A JavaScript library for building user interfaces">
                    <img src="https://s3.amazonaws.com/creativetim_bucket/tim_static_images/presentation-page/react.jpg" class="img-fluid rounded-circle opacity-3">
                  </a>
                </div>
              </div>
            </div>
