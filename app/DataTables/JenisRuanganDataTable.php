...
class JenisRuanganDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\JenisRuangan $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(JenisRuangan $model): QueryBuilder
    {
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
                    ...
                    ->setTableId('jenis-ruangan-table')
    ...
    {
        return 'JenisRuangan_' . date('YmdHis');
    }
}
