...
class BookingDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->editColumn('waktu_mulai_kegiatan', function($q){
            $waktu_mulai = MyHelpers::tgl_indo($q->waktu_mulai_kegiatan);
            return $waktu_mulai;
        })
        ->editColumn('waktu_selesai_kegiatan', function($q){
            $waktu_selesai = MyHelpers::tgl_indo($q->waktu_selesai_kegiatan);
    ...
    {
        return $model->where('status_peminjaman',1)->newQuery();
    }
